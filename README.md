...
[__init__ file](https://github.com/fellowship/Robotics-Simulator-Imitation-Learning/blob/main/PyBulletPerAct-main/panda_gym/__init__.py)).
...
[file](https://github.com/fellowship/Robotics-Simulator-Imitation-Learning/blob/main/PyBulletPerAct-main/panda_gym/envs/tasks/pick_and_place.py). 
...
* In [Pybullet.py](https://github.com/fellowship/Robotics-Simulator-Imitation-Learning/blob/main/PyBulletPerAct-main/panda_gym/pybullet.py), we 
substantially and carefully changed the rendering such that it is compatible with 
[Create_and_save_demo.ipynb](https://github.com/fellowship/Robotics-Simulator-Imitation-Learning/blob/main/Create_and_save_demo.ipynb).
...
Finally, the [PyBulletPerAct.ipynb](https://github.com/fellowship/Robotics-Simulator-Imitation-Learning/blob/main/PyBulletPerAct.ipynb) contains the 
